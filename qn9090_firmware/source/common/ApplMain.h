...
#if defined APP_DBG_LVL && (APP_DBG_LVL != DBG_LEVEL_NONE)
#include "fsl_debug_console.h"
#endif

#if (APP_DBG_LVL >= DBG_LEVEL_VERBOSE)
#define APP_VERBOSE_TRACE  PRINTF
#else
#define APP_VERBOSE_TRACE(...)
#endif
#if (APP_DBG_LVL >= DBG_LEVEL_DEBUG)
#define APP_DEBUG_TRACE  PRINTF
#else
#define APP_DEBUG_TRACE(...)
#endif

#if (APP_DBG_LVL >= DBG_LEVEL_INFO)
#define APP_INFO_TRACE  PRINTF
#else
#define APP_INFO_TRACE(...)
#endif

#if (APP_DBG_LVL >= DBG_LEVEL_WARNING)
#define APP_WARNING_TRACE  PRINTF
#else
#define APP_WARNING_TRACE(...)
#endif
