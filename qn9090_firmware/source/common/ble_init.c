...
extern bool_t Ble_ConfigureHostStackConfig(void);

#if  !(defined(CPU_QN908X) || defined(KW37A4_SERIES) || defined(KW37Z4_SERIES) || defined(KW38A4_SERIES) \
     ||  defined(KW38Z4_SERIES) || defined(KW39A4_SERIES) || defined(CPU_MK64FN1M0VLL12))
static xcvrStatus_t Ble_RadioInit(void);
#endif /* CPU_QN908X, KW37Z4_SERIES, KW38A4_SERIES, KW38A4_SERIES, KW38Z4_SERIES, KW39A4_SERIES, CPU_JN518X */
...
)
{
    ...
    if (!Ble_ConfigureHostStackConfig())
    {
...
#endif /* CPU_QN908X, KW37Z4_SERIES, KW38A4_SERIES, KW38A4_SERIES, KW38Z4_SERIES, KW39A4_SERIES */
...
#endif /* CPU_QN908X, KW37A4_SERIES, KW37Z4_SERIES, KW38A4_SERIES, KW38Z4_SERIES, KW39A4_SERIES */
...
#if  (defined(KW37A4_SERIES) || defined(KW37Z4_SERIES) || defined(KW38A4_SERIES) || \
      defined(KW38Z4_SERIES) || defined(KW39A4_SERIES) || defined(CPU_MK64FN1M0VLL12))
    /* Configures default TX power, coexistence, BD address */
    ...
    gMCUSleepDuringBleEvents = (bool_t)cMCU_SleepDuringBleEvents;
#endif /* CPU_QN908X, KW37A4_SERIES, KW37Z4_SERIES, KW38A4_SERIES, KW38Z4_SERIES, KW39A4_SERIES, CPU_JN518X */
...
static xcvrStatus_t Ble_RadioInit(void)
{
    ...
    #endif
    temperature = BOARD_GetTemperature(); /* Initial radio calibration function of temperature */ 
    XCVR_TemperatureUpdate(temperature);

    status = XCVR_Init(BLE_MODE, DATA_RATE);
    return status;
}

#elif  !(defined(CPU_QN908X) || defined(KW37A4_SERIES) || defined(KW37Z4_SERIES) || defined(KW38A4_SERIES) \
      || defined(KW38Z4_SERIES) || defined(KW39A4_SERIES) || defined(CPU_MK64FN1M0VLL12) \
      || defined (CPU_JN518X))
static xcvrStatus_t Ble_RadioInit(void)
{
