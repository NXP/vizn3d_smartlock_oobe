...
*************************************************************************************
************************************************************************************/
static osaTaskId_t  mControllerTaskId;
...
uint8_t gAdvertisingPacketInterval = mcAdvertisingPacketInterval_c;
...
uint16_t gAnchorPointDistance = 0x20;
#if 0
...
/*! *********************************************************************************
* \brief  Application wrapper Controller_TaskHandler
*
...
#if !defined(CPU_QN908X) && !defined(CPU_JN518X)
/*! *********************************************************************************
* \brief Sets the Bluetooth Device Address
*
* \param[in] none
*
* \return none
...
osaStatus_t Controller_TaskInit(void)
{
    ...
    OSA_InstallIntHandler((uint32_t)BTLL_RSIM_IRQn, &Controller_InterruptHandler);
    ...
    OSA_InstallIntHandler((uint32_t)Radio_0_IRQn, &Controller_InterruptHandler);
    ...
    OSA_InstallIntHandler((uint32_t)RF0_0_IRQn, &Controller_InterruptHandler);
...
#elif (defined(CPU_QN908X) || defined(CPU_MK64FN1M0VLL12) || defined(CPU_JN518X))
#else
...
void Controller_ParamInit(void)
{
    ...
    /* Save gBD_ADDR in public structure */
    Controller_SetDeviceAddress(gBD_ADDR);
}
