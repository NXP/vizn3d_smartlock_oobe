...
{
    /* Change clock source to pll3 in order to enable the spread spectrum for Pll2 */
    clock_root_config_t root_clock_flexspi1 = {.mux = kCLOCK_FLEXSPI1_ClockRoot_MuxSysPll3Out, .div = 4};
